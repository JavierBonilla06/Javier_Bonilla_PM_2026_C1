...
#include <math.h>
/*
El programa recibe 24 numeros reales que representa las temperaturas
en el exterior en un periodo de 24 horas. Calcula el promedio del
dia y las temperatuas maxima y minima con la hora en la que se
registraron
*/

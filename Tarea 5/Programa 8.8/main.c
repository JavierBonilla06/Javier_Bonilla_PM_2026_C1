...
void F2(paciente A[], int T)
{
        ...
        switch (A[I].con)
    {
        ...
        printf("\nNumeros de pacientes en condicion 1: %d", C1);
        printf("\nNumeros de pacientes en condicion 2: %d", C2);
        printf("\nNumeros de pacientes en condicion 3: %d", C3);
        printf("\nNumeros de pacientes en condicion 4: %d", C4);
        printf("\nNumeros de pacientes en condicion 5: %d", C5);
}
